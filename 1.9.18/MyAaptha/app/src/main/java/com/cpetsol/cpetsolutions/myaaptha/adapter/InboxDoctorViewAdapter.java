...
public class InboxDoctorViewAdapter extends BaseAdapter {
    ...
    public InboxDoctorViewAdapter(FragmentActivity inboxActivity, ArrayList<InboxModel> inbox) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        File=(ImageView)view.findViewById(R.id.tvFileName);
        final InboxModel model = appItmList.get(i);
        Log.i("content",model.toString());
            ...
            public void onClick(View view) {
                FileLoader.with(activity)
                    /* .load("http://www.myaaptha.com/pp/UserFiles/900000010501/1.jpg")*/
                        ...
                        .asFile(new FileRequestListener<java.io.File>() {
                            @Override
