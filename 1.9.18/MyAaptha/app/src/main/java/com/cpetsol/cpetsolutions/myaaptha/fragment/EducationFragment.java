...
public class EducationFragment extends Fragment {
    ...
    private Spinner SQualif,SFamilyNames;
...
//    private GalleryPhoto galleryPhoto;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try{
            rootView=inflater.inflate(R.layout.education_fragment,container,false);
...
//            fontAwesomeFont = Typeface.createFromAsset(getActivity().getAssets(), "fontawesome-webfont.ttf");
    ...
    private void init() {
        ...
        SQualif=(Spinner)rootView.findViewById(R.id.sQualification);
...
//                startActivityForResult(in, GALLERY_REQUEST);
    ...
    private void validations() {
        try{
            ...
            String[] strIds = getResources().getStringArray(R.array.EducationDetails_ids_array);
            String[] strErrMsgs = getResources().getStringArray(R.array.EducationDetails_errors_array);
            String[] strCompTypeArr = getResources().getStringArray(R.array.EducationDetails_comptypes_array);
...
//                    new UploadFileToServer().execute();
    ...
    public class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        String sFamName,EBirthday,EDetails,sQual  ;
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(getActivity(),     "Please wait",   "loading...");
            sFamName=SFamilyNames.getSelectedItem().toString();
            sQual=SQualif.getSelectedItem().toString();
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                obj= new JSONObject();
                obj.accumulate("documentCategory","Education Details");
                obj.accumulate("familyNames",sFamName);
                obj.accumulate("qualification",sQual);
