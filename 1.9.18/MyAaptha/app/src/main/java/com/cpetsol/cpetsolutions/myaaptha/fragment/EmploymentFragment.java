...
public class EmploymentFragment extends Fragment {
    ...
    private EditText ETCompany,ETDetails,ETDate;
...
//    private GalleryPhoto galleryPhoto;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        try{
            rootView=inflater.inflate(R.layout.employment_fragment,container,false);
...
//            fontAwesomeFont = Typeface.createFromAsset(getActivity().getAssets(), "fontawesome-webfont.ttf");
    ...
    private void init() {
        ETCompany=(EditText)rootView.findViewById(R.id.et_Company);
...
//                startActivityForResult(in, GALLERY_REQUEST);
    ...
    private void validations() {
        try{
            ...
            String[] strIds = getResources().getStringArray(R.array.EmpDetails_ids_array);
            String[] strErrMsgs = getResources().getStringArray(R.array.EmpDetails_errors_array);
            String[] strCompTypeArr = getResources().getStringArray(R.array.EmpDetails_comptypes_array);
    ...
    public class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        String EBirthday,EDetails,EComapany  ;
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(getActivity(),     "Please wait",   "loading...");
            EComapany=ETCompany.getText().toString();
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                obj= new JSONObject();
                obj.accumulate("documentCategory","Employment Details");
                obj.accumulate("companyName",EComapany);
