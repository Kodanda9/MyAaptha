 ...
 */
public class HelathDetailsFragment extends Fragment {


    private View rootView;
    private Spinner SFmaName,ETCategory;
...
//    private GalleryPhoto galleryPhoto;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        try{
            rootView=inflater.inflate(R.layout.helath_details_fragmetnt,container,false);
...
//            fontAwesomeFont = Typeface.createFromAsset(getActivity().getAssets(), "fontawesome-webfont.ttf");
    ...
    private void init() {
        SFmaName=(Spinner)rootView.findViewById(R.id.sFamilynames);
        ETCategory=(Spinner)rootView.findViewById(R.id.et_Category);
...
//                startActivityForResult(in, GALLERY_REQUEST);
    ...
    private void validations() {
        try{
            ...
            String[] strIds = getResources().getStringArray(R.array.HealthDetails_ids_array);
            String[] strErrMsgs = getResources().getStringArray(R.array.HealthDetails_errors_array);
            String[] strCompTypeArr = getResources().getStringArray(R.array.HealthDetails_comptypes_array);
    ...
    public class FamilyNamesAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            SFmaName.setAdapter(new ArrayAdapter<String>(getActivity(),android.R.layout.simple_spinner_dropdown_item,familyList));
        }
    }//AddEduAsyncTask

    public class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ProgressDialog progressDialog;
        String famName,EBirthday,EDetails,ECategry  ;
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(getActivity(),     "Please wait",   "loading...");
            famName=SFmaName.getSelectedItem().toString();
            ECategry=ETCategory.getSelectedItem().toString();
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                obj= new JSONObject();
                obj.accumulate("documentCategory","Health Details");
                obj.accumulate("familyNames",famName);
                obj.accumulate("category",ECategry);
