...
import com.cpetsol.cpetsolutions.myaaptha.adapter.MedicineHall_Adapter;
...
public class Medicines_HallFragment extends Fragment {
...
//            AppHelper.setupHideleyboard(rootView,getActivity());
    ...
    private class MedicineHallTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            String Content= AsyncTaskHelper.makeServiceCall(ApisHelper.allMedicinesHall,"GET",null);
       //     String Content= AsyncTaskHelper.makeServiceCall("http://myaaptha.com/pp/medicalRest/allMedicinesHall","GET",null);
            Log.i("======>",Content);
            return Content;
        }
...
MedicineHall_Adapter adapter=new MedicineHall_Adapter(getActivity(),rowItems);
