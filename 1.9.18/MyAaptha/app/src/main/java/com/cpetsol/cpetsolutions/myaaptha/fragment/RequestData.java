...
import com.cpetsol.cpetsolutions.myaaptha.adapter.InboxAdapter;
...
public class RequestData extends Fragment {

    private View rootView;

    private ListView requestData,doctorData,userData,reportss;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        requestData=(ListView)rootView.findViewById(R.id.requestdata);
