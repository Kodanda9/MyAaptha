...
import com.cpetsol.cpetsolutions.myaaptha.adapter.InboxUserViewAdapter;
...
public class UserReports extends Fragment {
    ...
    private ArrayList<InboxModel> userreports;
    private View rootView;
    private ListView userreport;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        userreport = (ListView) rootView.findViewById(R.id.userview);
    ...
    private class InboxData extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            userreports= new ArrayList<InboxModel>();
