...
public class RecordDialog extends DialogFragment {
    ...
    public static RecordDialog newInstance(Activity mainActivity, String title) {
...
//        LayoutInflater inflater = LayoutInflater.from(getActivity());
            ...
            public void onClick(View v) {
                ...
                switch (STATE_BUTTON) {
                    case "INIT":
                        ...
                        STATE_BUTTON = "RECORD";
                        try {
                            mPlayer = MediaPlayer.create(activityContext, R.raw.hangouts_message);
                            mPlayer.start();
        ...
        String strTitle = _strTitle == null ? "MyAaptha audio" : _strTitle;
...
//        final Interpolator interpolador = AnimationUtils.loadInterpolator(getContext(),
        final Interpolator interpolador = AnimationUtils.loadInterpolator(activityContext,
